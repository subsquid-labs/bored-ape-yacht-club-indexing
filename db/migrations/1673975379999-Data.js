module.exports = class Data1673975379999 {
    name = 'Data1673975379999'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "uri" text, "image_url" text, "owner_id" character varying, "contract_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
